...
public class EmpleadoController {
    ...
    @GetMapping("{id}")
    public ResponseEntity<List<RespuestaCliente>> getClientes(@PathVariable Long id) throws PermisosInsuficientesException,
            EmpleadoNoEncontradoException, ClienteException {
